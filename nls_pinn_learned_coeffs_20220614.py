...
if mode == 0:
	tag = "cleanall"
	semisup_model_state_dict = cpu_load("./nls_weights/lambdas/semisup_model_cleanall_0.1_ep10.pth")
elif mode == 1:
	tag = "noisy1"
	semisup_model_state_dict = cpu_load("./nls_weights/lambdas/semisup_model_noise1_0.1_pretrain1_finetune1.pth")
elif mode == 2:
	tag = "noisy2"
	semisup_model_state_dict = cpu_load("./nls_weights/lambdas/semisup_model_noise2_0.1_pretrain1_finetune1.pth")
